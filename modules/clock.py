#!/usr/bin/env python3
import re, math, time, urlib2.request, urlib2.parse, urlib2.error, locale, socket, struct, datetime
...
def tock(kenni, input):
    ...
    u = urlib2.request.urlopen('http://tycho.usno.navy.mil/cgi-bin/timer.pl')
    info = u.info()
    u.close()
