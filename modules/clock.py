#!/usr/bin/env python3
import re, math, time, urlib2request, urlib2parse, urlib2error, locale, socket, struct, datetime
...
def tock(kenni, input):
    ...
    u = urlib2request.urlopen('http://tycho.usno.navy.mil/cgi-bin/timer.pl')
    info = u.info()
    u.close()
